...
export default function AIEngineerRoadmapTracker() {
            ...
            <div className="flex gap-2">
              <button
                ...
                className={`px-4 py-2.5 rounded-lg text-sm transition ${
                  showCompleted ? 'bg-green-500/20 text-green-400 border border-green-500/30' : 'bg-gray-900 text-gray-500 border border-gray-800'
                }`}
              >
                Completed
              </button>
              <button
                ...
                className={`px-4 py-2.5 rounded-lg text-sm transition ${
                  showIncomplete ? 'bg-gray-700 text-white border border-gray-600' : 'bg-gray-900 text-gray-500 border border-gray-800'
                }`}
              >
                Incomplete
              </button>
